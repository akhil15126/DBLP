...
import javax.swing.*;
/**
*This class is basically responsible to handle GUI related exceptions
*/
...
return 0;}public double myprediction(int aa){
Random r=new Random();
int mm=0;
while(mm==0)
...
///Functionality for By Relevence search
void byrelev(){
